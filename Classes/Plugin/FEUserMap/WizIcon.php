...
class WizIcon {
    public function proc($wizardItems)    {
        $wizardItems['plugins_tx_wecmap_pi2'] = array(
            'icon'=>\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('wec_map').'Resources/Public/Images/FEUserMapWizIcon.gif',
            'title'=>$GLOBALS['LANG']->sL('LLL:EXT:wec_map/Resources/Private/Languages/Plugin/FEUserMap/locallang.xlf:pi2_title'),
            'description'=>$GLOBALS['LANG']->sL('LLL:EXT:wec_map/Resources/Private/Languages/Plugin/FEUserMap/locallang.xlf:pi2_plus_wiz_description'),
