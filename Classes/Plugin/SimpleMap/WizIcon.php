...
class WizIcon {
    public function proc($wizardItems)    {
        $wizardItems['plugins_tx_wecmap_pi1'] = array(
            'icon'=>\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('wec_map').'Resources/Public/Images/SimpleMapWizIcon.gif',
            'title'=>$GLOBALS['LANG']->sL('LLL:EXT:wec_map/Resources/Private/Languages/Plugin/SimpleMap/locallang.xlf:pi1_title'),
            'description'=>$GLOBALS['LANG']->sL('LLL:EXT:wec_map/Resources/Private/Languages/Plugin/SimpleMap/locallang.xlf:pi1_plus_wiz_description'),
